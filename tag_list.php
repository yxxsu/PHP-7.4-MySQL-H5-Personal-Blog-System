...
$list = $pdo->query("SELECT * FROM tag ORDER BY sort ASC,id DESC")->fetchAll();
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<div class="container mt-4">
    <div class="d-flex justify-content-between mb-3">
        <h4>标签列表</h4>
        <a href="tag_add.php" class="btn btn-success">新增标签</a>
    </div>
        ...
        <table class="table">
            ...
            <?php foreach($list as $v):?>
                <tr>
                    ...
                    <td>
                        <a href="tag_edit.php?id=<?=$v['id']?>" class="btn btn-sm btn-outline-success">编辑</a>
                        <a href="tag_del.php?id=<?=$v['id']?>" onclick="return confirm('确定删除？')" class="btn btn-sm btn-outline-danger">删除</a>
                    </td>
                </tr>
            <?php endforeach;?>
            </tbody>
